...
| **NF-4** (ANATEL 605/2012 é SCM/SMP, não STFC/0800) | **Resolvido — risco de escopo eliminado** | A norma mis-escopada (605/2012, RGQ-SCM/SMP) foi **removida** e **substituída** pelo **RGC — Resolução ANATEL nº 632/2014**, cujo escopo **abrange expressamente o STFC** (serviço sob o qual operam os 0800). Não resta hipótese de risco: a nova âncora cobre o serviço correto e é `[CONFIRMADO]` (norma vigente e verificável). O ponto levantado pela auditoria — escopo SCM/SMP não cobrir STFC — **deixou de existir**, pois a citação ao 605/2012 não é mais usada como âncora do canal (Seção 4B). |
